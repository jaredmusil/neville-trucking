...
https://neville-trucking.netlify.com/
...
- [Snipcart](http://snipcart.com) - eCommerce and payments
...
[params.topbar]
    enable = true
    text = "<p>Contact us at (309)-359-8400 or <a href="mailto:nevilletrucking@yahoo.com">nevilletrucking@yahoo.com</a>.</p>"
```
...
[params.testimonials]
    enable = true
    title = "Testimonials"
    subtitle = "We have worked with many service-areas and we always like to hear they come out from the cooperation happy and satisfied. Have a look what our service-areas said about us."
```
...
The service-areas section is used to show a list of logos of companies you have collaborated with. The service-areas are defined in the `data` directory as YAML files.
...
```yaml
name: "customer-1"
image: "img/service-areas/customer-1.png"
